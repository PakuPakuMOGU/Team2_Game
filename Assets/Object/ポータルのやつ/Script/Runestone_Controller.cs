...
public class Runestone_Controller : MonoBehaviour
{
    ...
    [SerializeField] private Light portalLight2;
    ...
    private IEnumerator TransitionSequence()
    {
        ...
        while (inTransition)
        {
            ...
            portalLight2.intensity = maxIntPortalLight * fadeFloat;
    ...
    private IEnumerator AnimateActiveEffects()
    {
        ...
        while (animating)
        {
            ...
            portalLight2.intensity = Mathf.MoveTowards(portalLight.intensity, randIntencity, Time.deltaTime * 1.5f);
